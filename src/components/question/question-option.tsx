  ...
  const statusClass =
    status === "correct"
      ...
      : status === "wrong"
        ...
        : "border-gray-200 bg-white text-gray-800 hover:border-blue-400 hover:bg-blue-50 dark:border-slate-700 dark:bg-slate-950 dark:text-white";

  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={`w-full rounded-2xl border p-4 text-left font-semibold transition disabled:cursor-not-allowed ${statusClass}`}
    >
